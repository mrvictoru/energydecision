...
RUN_TIERS: dict[str, RunTier] = {
    "proxy-smoke": RunTier(
        ...
        dataset_path="data/aemo_dt/autoresearch_pilot/aemo_dt_train_pilot.parquet",
        val_dataset_path="data/aemo_dt/autoresearch_pilot/aemo_dt_val_pilot.parquet",
        batch_size=32,
        epochs=1,
        lr=3e-5,
    ...
    "proxy-baseline": RunTier(
        slug="proxy_baseline",
        description="Canonical fixed-split proxy baseline for iterative AEMO DT search.",
        surface_preset="aemo_proxy",
        dataset_path="data/aemo_dt/autoresearch_pilot/aemo_dt_train_pilot.parquet",
        val_dataset_path="data/aemo_dt/autoresearch_pilot/aemo_dt_val_pilot.parquet",
        batch_size=128,
