...
*   [x] **AEMO preferred-policy recommendation (verified 2026-08):** The standalone DT should now ship with **surface-aware `rtg_mode="auto"`**: it reproduces the `j_t_soc` wins on **all 4 identity surfaces** — standard **$11.6k/ep vs PPO $2.35k**, dispatch-matched **$35.3k vs $22.5k**, expanded broad-2024 **$34.8k vs $19.5k**, and **2025 OOD $25.9k vs $6.5k** — while preserving the **impact-gate pass** by falling back to constant RTG under merit-order impact. Explicit `j_t_soc` remains stronger on identity but is **not** the shipped default because it still fails hornsdale/torrens under market impact.
