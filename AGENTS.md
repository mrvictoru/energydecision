...
- **Household**: ausgrid solar-battery (SolarBatteryEnv) — on the **legacy Ausgrid benchmark** the DT beats Oracle; on the **modern 2019+ real-telemetry rebuild** the perfect-foresight oracle instead dominates (best DT gross +$293–357/yr vs RTE-matched oracle +$690/yr) and the DT over-cycles on long horizons (net-of-wear −$114/−$238/yr at 30/90 d; see `docs/household/workflow.md` §H4.4/H4.9 and `docs/known_issues.md`).
