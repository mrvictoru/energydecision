...
python3 scripts/autoresearch_evaluator.py \
  ...
  --evaluation-config configs/aemo_autoresearch_evaluator.sdp_teacher_standard_freshprobe.json \
  --output-dir eval_output/physics_v2/standard_v2cal_cachekeytest
