...
| Multi-seed RL baselines | 🟡 Training complete; deployment evaluation pending | Three seeds each at 250k timesteps completed for PPO, SAC, and TD3 on the H4.1 training corpus. Test mean rewards were PPO −1763.5 (SD 18.8), SAC −1765.3 (SD 5.0), and TD3 −1876.8 (SD 247.3); TD3 has one clear seed-collapse outlier. | Evaluate all nine checkpoints on the same real/synthetic safety-wrapped household surfaces before making DT-versus-RL claims. |
