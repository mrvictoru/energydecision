...
| Multi-seed RL baselines | 🟡 Fair synthetic deployment comparison complete; real-OOD comparison pending | Three seeds each at 250k timesteps completed for PPO, SAC, and TD3 on the H4.1 training corpus. A fair matched 5 kWh / 3.3 kW comparison now applies identical 1%–99% SOC, independent 0.05 charge/discharge EFC/day, and `$0.30/$0.10` price-gate wrappers. On three matched 180-day windows, DT (`rtg=-4`) achieved +A$2.98/year with 0.04995 EFC/day, 0 SOC clips, and 0 safety penalty; PPO/SAC were mixed across seeds and TD3 was mostly under-active. | Extend the same comparison to broader seasonal and real OOD windows before claiming general DT superiority. |
